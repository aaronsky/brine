...
- (id)init
{
    id<GHAstBuilderProtocol> builder = (id<GHAstBuilderProtocol>)[[GHAstBuilder alloc] init];
...
{
    __block id<GHAstBuilderProtocol> blockSafeBuilder = astBuilder;
    void (^tempFunction)(void) = ^() {
        [blockSafeBuilder buildWithToken: theToken];
    };
    [self handleAstErrorWithContext: theContext actionBlock: tempFunction];
}
...
- (void)startRuleWithContext:(GHParserContext *)theContext ruleType:(GHRuleType)theRuleType
{
    __block id<GHAstBuilderProtocol> blockSafeBuilder = astBuilder;
    void (^tempFunction)(void) = ^() {
        [blockSafeBuilder startRuleWithType: theRuleType];
    };
    [self handleAstErrorWithContext: theContext actionBlock: tempFunction];
}
...
- (void)endRuleWithContext:(GHParserContext *)theContext ruleType:(GHRuleType)theRuleType
{
    __block id<GHAstBuilderProtocol> blockSafeBuilder = astBuilder;
    void (^tempFunction)(void) = ^() {
        [blockSafeBuilder endRuleWithType: theRuleType];
    };
    [self handleAstErrorWithContext: theContext actionBlock: tempFunction];
}
